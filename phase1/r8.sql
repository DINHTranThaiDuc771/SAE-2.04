...
CREATE OR REPLACE view best5(numClient,nomClient,mailClient,quantiteBD,coutA) AS  
Select c.numClient, nomClient, mailClient, Sum(quantite) , Sum(prixVente*quantite) 
